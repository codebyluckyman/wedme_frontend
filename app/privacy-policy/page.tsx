...
export default function PrivacyPolicy() {
    return (
      <div className="max-w-4xl mx-auto px-8 py-8 prose prose-slate">
        ...
        <p>Their Privacy Policy can be viewed at <a href="www.gmail.com" rel="external nofollow noopener" target="_blank">www.gmail.com</a></p>
        </li>
        </ul>
        ...
        <ul>
        <li>By email: <a href="/cdn-cgi/l/email-protection" className="__cf_email__" data-cfemail="364253575b45434646594442764153525b5318575f">[email&#160;protected]</a></li>
        </ul>
        ...
        <h2><strong>Use of Google Workspace APIs and AI/ML Model Development Policy</strong></h2>
        <h3>Compliance with Google Workspace API Usage</h3>
        <p>We affirm that the Google Workspace APIs accessed through our services are not used for developing, improving, or training generalized artificial intelligence (AI) or machine learning (ML) models.</p>

        <h3>Purpose of API Usage</h3>
        <p>Our use of Google Workspace APIs is strictly limited to enhancing the user experience and functionality of our services as explicitly described in our service documentation and does not extend to any form of AI or ML model development.</p>

        <h3>Data Handling and Processing</h3>
        <p>All data accessed via Google Workspace APIs is processed in accordance with our privacy policy, strictly adhering to the intended purpose as specified and not for the development of generalized AI or ML technologies.</p>

        <h3>Restrictions on Data Use</h3>
        <p>We ensure that no data obtained from Google Workspace APIs will be used to train, calibrate, or improve the capabilities of AI or ML systems, algorithms, or models.</p>

        <h3>Transparency and Disclosure</h3>
        <p>We are committed to maintaining full transparency about our use of data obtained from Google Workspace APIs and will continuously provide clear disclosures about the specific purposes for which this data is used.</p>
        ...
        <ul>
          <li>By email: <a href="mailto:info@wedme.ai">teamsupport@wedme.ai</a></li>
        </ul>
      </div>
        );
    }